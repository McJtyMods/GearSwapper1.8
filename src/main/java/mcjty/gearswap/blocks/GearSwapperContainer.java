    ...
    public GearSwapperContainer(EntityPlayer player, GearSwapperTE gearSwapperTE) {
        ...
        if (baublesInventory != null) {
            for (int i = 0; i < 4; i++) {
                int x = 87;
                int y = 6 + i * 39;
                addSlotToContainer(new GhostSlot(gearInventory, index++, x, y, GhostSlot.BAUBLE_AMULET));
                x += 18;
                addSlotToContainer(new GhostSlot(gearInventory, index++, x, y, GhostSlot.BAUBLE_RING));
                x += 18;
                addSlotToContainer(new GhostSlot(gearInventory, index++, x, y, GhostSlot.BAUBLE_RING));
                x += 18;
                addSlotToContainer(new GhostSlot(gearInventory, index++, x, y, GhostSlot.BAUBLE_BELT));
                x += 18;
            }
        }
